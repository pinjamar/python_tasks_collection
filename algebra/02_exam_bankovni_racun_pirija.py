...
def open_account():
    ...
    if amount != '':
        ...
        # KOMENTAR FS - niste povećali transaction_id za 1, ovako će vam uvijek biti 0 i nikad se neće povećati, ispod je rješenje
        transaction_id += 1
    else:
        amount = 0.00
...
def display_historical_transactions():
    ...
    # KOMENTAR FS - ovdje vam je samo bilo dovoljno da ste koristili nešto kao:
    #       for key, value in transactions.items():
    #           print(key, value)
    # To je neki najjednostavniji prikaz

    # Vi ste u vašem kodu imali grešku jer je transactions rječnik - a vi koristite sintaksu koji mi nismo radili i koja se ne koristi - znači za iteracije kroz rječnik uvijek imamo: keys(), values() ili items()
    # funkcije
...
def create_deposit_transaction():
    ...
    if uplata != '':
        ...
        transactions[transaction_id + 1] = transactions
        # KOMENTAR FS - kao i gore vali inkrement
        transaction_id += 1
    ...
    # create_deposit_transaction() # KOMENTAR FS - ovime ste ušli u beskonačnu petlju i svaki put kad unesem neki zinos novaca mene opet pita da unesem još i tako u krug i ne mogu van. Ovo je višak. 
...
# KOMENTAR FS - dodao sam vam gore komentare pa si pogledajte. 
# Sve u svemu uz neke moje intervencije kod radi super, probajte sad uz moje instrukcije napraviti ovu funkciju za prikaz prometa. Stvar je samo u iteraciji kroz rječnik. 
# Dobro je, nije odlično, ali svakako ste prošli, malo još probajte shvatiti gdje ste griješili i bit će odlično :D
# Ako nešto nije jasno u vezi komentara slobodno me kontaktirajte. 